...
class UserController {
  ...
  initializeRoutes() {
    this.router.get('/users', Auth.authenticateToken, this.getAllUsers.bind(this));
    this.router.get('/user/:id', Auth.authenticateToken, this.getUserById.bind(this));
    this.router.delete('/user/:id', Auth.authenticateToken, this.deleteUser.bind(this));
  ...
  async registerUser(req, res) {
    const { username, password, employee_id, email, department } = req.body;
    try {
      await this.db.query(
